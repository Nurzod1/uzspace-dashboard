<template>
  <div class="sidebar-wrapper">
    ...
    <div class="sidebar-menu">
      <button v-for="(menuItem, index) in menuItems" :key="index" class="sidebar-menu__item"
...
const menuItems = [
  { icon: ChartPieSlice, text: 'Overview' },
  { icon: Download, text: 'Upload Logs' },
  { icon: ArrowsClockwise, text: 'Status Updates' },
  { icon: MapTrifold, text: 'Map' }
];
